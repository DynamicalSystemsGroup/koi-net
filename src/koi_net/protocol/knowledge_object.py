...
class KnowledgeObject(BaseModel):
    ...
    (:attr:`.normalized_event_type`, :attr:`.source`, :attr:`.network_targets`)
    used for decision making in the knowledge processing pipeline.
    ...
    will take place. (:attr:`~koi_net.protocol.event.EventType.NEW`,
    :attr:`~koi_net.protocol.event.EventType.UPDATE`) -> cache write,
    :attr:`~koi_net.protocol.event.EventType.FORGET` -> cache delete,
    ``None`` -> no cache action, and end of pipeline.
    ...
    def from_rid(
        ...
        """Creates a :class:`.KnowledgeObject` from an ``RID``."""
    ...
    def from_manifest(
        ...
        """Creates a :class:`.KnowledgeObject` from a ``Manifest``."""
    ...
    def from_bundle(
        ...
        """Creates a :class:`.KnowledgeObject` from a ``Bundle``."""
    ...
    def from_event(
        ...
        """Creates a :class:`.KnowledgeObject` from an
        :class:`~koi_net.protocol.event.Event`."""
